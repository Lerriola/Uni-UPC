...
void MyGLWidget::paintGL ()
{
    ...
    // Pintem paraigües 1
    black = 1;
    glUniform1i (blackLoc, black);
    modelTransformUmbrella (2, glm::vec3(-0.5, 0.0, 0.0), 0.5, false);
    pintaUmbrella ();

    // Pintem paraigues 2
    modelTransformUmbrella (2, glm::vec3(0.5, 0.0, 0.0), 0.5, true);
    pintaUmbrella ();
    ...
    glUniform1i(blackLoc,black);
        ...
        // Pintem paraigües 1
    modelTransformUmbrella (2, glm::vec3(-0.5, 0.0, 0.0), 0.25, false);
    pintaUmbrella ();

    // Pintem paraigues 2
    modelTransformUmbrella (2, glm::vec3(0.5, 0.0, 0.0), 0.25, true);
    pintaUmbrella ();
...
void MyGLWidget::modelTransformUmbrella (float anglegir, glm::vec3 posicioCentre, float escala , bool rodaDreta)
{
    ...
    //Rotacio T
    TG = glm::rotate(TG, RotaT , glm::vec3(1.0, 0.0, 0.0));

    // Rotacio R
    TG = glm::rotate(TG, RotaR , glm::vec3(0.0, 0.0, 1.0));
...
void MyGLWidget::keyPressEvent(QKeyEvent* event) 
{
    ...
    case Qt::Key_R: { // rotació Umbrella 1
        RotaR +=  glm::radians(15.f);
        break;
    }
    case Qt::Key_T: { // rotació Umbrella 2
        RotaT += glm::radians(15.f);
        break;
    }
...
void MyGLWidget::carregaShaders()
{
    ...
    // Pintem els Parametres en negre
