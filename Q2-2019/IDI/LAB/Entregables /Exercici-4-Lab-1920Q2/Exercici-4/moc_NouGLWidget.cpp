...
QT_MOC_LITERAL(1, 12, 12), // "sliderKeySet"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 6), // "xfocus"
QT_MOC_LITERAL(4, 33, 14) // "sliderFocusSet"

    },
    "NouGLWidget\0sliderKeySet\0\0xfocus\0"
    "sliderFocusSet"
};
...
void NouGLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        NouGLWidget *_t = static_cast<NouGLWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sliderKeySet((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->sliderFocusSet((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (NouGLWidget::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&NouGLWidget::sliderKeySet)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void NouGLWidget::sliderKeySet(int _t1)
{
