...
QT_MOC_LITERAL(1, 12, 8), // "TeclaSet"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 1), // "s"
QT_MOC_LITERAL(4, 24, 8) // "SetFocus"

    },
    "NouGLWidget\0TeclaSet\0\0s\0SetFocus"
};
...
void NouGLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->TeclaSet((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        {
            typedef void (NouGLWidget::*_t)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&NouGLWidget::TeclaSet)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void NouGLWidget::TeclaSet(QString _t1)
{
