...
void MyGLWidget::modelTransformPatricio ()
{
  ...
  TG = glm::translate(TG, glm::vec3(1, -0.2, 0));
  TG = glm::rotate(TG, angleRot , glm::vec3(0,1,0));
  TG = glm::scale(TG, glm::vec3(0.25*escalaPat));
...
void MyGLWidget::modelTransformVaca ()
{
  ...
  TG = glm::rotate(TG, angleRot, glm::vec3(0,1,0));
  TG = glm::translate(TG, -glm::vec3(0.25, 0, 0));
  TG = glm::rotate(TG, -float(0.5*M_PI), glm::vec3(0,0,1));
  TG = glm::rotate(TG, -float((0.5)*M_PI), glm::vec3(0,1,0));
  TG = glm::scale(TG, glm::vec3(escalaVaca*0.5));
  TG = glm::translate(TG, -centreBaseVaca);
...
void MyGLWidget::creaBuffersVaca()
{
  // Carreguem el model de l'OBJ - Atenció! Abans de crear els buffers!
  Vaca.load("./models/cow.obj");

  // Calculem la capsa contenidora del model
  calculaCapsaModel (Vaca, escalaVaca, centreBaseVaca);
